...
- 💻 **Syntax-highlighted Code** — GitHub Dark theme code blocks
...
|---------|----------|-----|
| Voice Reader | Bottom-Right 🟣 | Click to open panel → Click "Read Page" |
| AI Chatbot | Bottom-Left 🟢 | Click to open chat → Type any Java question |
| YouTube Links | Top-Right 🔴 | Click "Resources" button |
